	...
	return (
		<div className="flex flex-col md:px-12 px-0 relative bg-background font-poppins items-center min-h-screen">
			...
			>
				<input
					type="text"
					className="flex w-full rounded-lg px-5 py-3 border-2 text-base text-background font-semibold focus:outline-none focus:ring-2 focus:ring-active"
				...
				<div className="mt-5 flex sm:flex-row flex-col justify-start">
					<div className="sm:w-1/3 w-full">
						...
						<select
							className="mt-1 border  flex w-full rounded-lg px-5 py-3 text-base text-background font-bold focus:outline-none"
					...
					<div className="sm:ml-10 sm:w-1/3 w-full">
						...
						<input
							type="number"
							className="mt-1 border-2  w-full rounded-lg px-5 py-3 text-base text-background font-bold focus:outline-none"
				...
				<button
					className="mt-5 w-full rounded-lg px-5 py-3  bg-[red] text-base text-primary font-bold hover:text-active hover:bg-[blue] transition-colors duration-300 sm:px-10"
					type="submit"
				>
					Search
				</button>
